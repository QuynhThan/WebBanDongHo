			...
			<div style="text-align: right;  border-width :2px 0px 0px 0px; border-color: gray; border-style: solid;" class="mb-3">
				...
				<c:if test="${i.TRANGTHAI >= 0}">
					...
					<!-- Lúc này lấy manv gán cho phiếu đặt -->
						...
						<a href="index/myhoadon/${i.MAPD }.htm" class="btn btn-primary " style="width: 100px; margin-bottom: 30px;margin-right: 40px;">
							Xem hóa đơn
						</a>
						</c:if>
						<c:if test="${i.TRANGTHAI == 0 }">
						
						<a href="index/mydon/${i.MAPD }.htm?btnHuy" class="btn btn-primary " style="width: 100px; background-color: orangered; margin-bottom: 30px; margin-right: 40px;">
							Hủy
						</a>
						</c:if>
