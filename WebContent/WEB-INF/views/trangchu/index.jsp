...
#hero{
	background-image:url("<c:url value = '/imgweb/rolex-swiss-made.jpg'/>");
	height: 90vh;
	width: 100%;
...
#product1 .pro-container .pro a i:hover{
...
<body>
	<section id="header" style="padding-right: 10px;">
	...
	justify-content: center;">${cart.size()}</span></a></li>
				...
				<li >
					...
					<ul class="sub-menu" style="padding: 0px 0px 0px 0px; 	background: #e3e6f3; ">
						<c:if test="${not empty isSigned}">
							<li style="padding: 10px 0px;"><a href="index/change-pass.htm">Đổi mật khẩu</a></li>
	...
	<section id="hero" >
		...
		<h1 style="color: white;">On all products</h1>
		<p style="color: white;">Save more with coupons and up to 70% off</p>
		<button ><a href="#product1" type="button">Shop Now</a></button>
	</section>
...
<%-- 					<form action="them/${d.getMaDH()}.htm" method="post"> --%>
					<a href="index/shopping/${d.MADH }.htm" type="img"><img src="<c:url value = 'imgweb/dongho/${d.getHINHANH()}'/>" alt="" ></a>
				<div class="des">
				...
				<c:if test="${d.getSOLUONGTON() > 0 }"><a href="bandongho/them/${d.getMADH()}.htm"><i class="fas fa-shopping-cart cart"></i></a>
					</c:if>
			</div>
			</c:forEach>
	...
	<section id="product1" class ="section-p1">
		...
		<div class="pro-container">
			<c:forEach var = "d" items = "${dh}">
				<div class="pro">
				<img src="imgweb/dongho/${d.getHINHANH()}" alt="" >
				<div class="des">
		...
		<div class="col">
			...
			<div class="follow">
				...
				<div class="icon">
					...
					<a href="https://www.instagram.com/tn.quyh/"><i class="fab fa-instagram" ></i></a>
