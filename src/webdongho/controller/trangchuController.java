...
public class trangchuController extends QuanTriController{
	...
	@RequestMapping( value="mydon/{MAPD}.htm", params = "btnHuy" )
	private String hDonDat(HttpServletRequest request ,ModelMap model, @PathVariable("MAPD") String MAPD ) {
		...
		TAIKHOAN tk = (TAIKHOAN) s.getAttribute("tk");
		return myCart(request, model, tk.getMAKH_TK().getMAKH());
	}
